            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <select class="changeLanguage" data-width="fit">
                            @php 
                                if(!empty($filesLang))
                                {
                                    foreach($filesLang as $mylangs)
                                    {
                                        if(Lang::locale() == $mylangs)
                                        {
                                            $selected = "selected='selected'";
                                        }else{
                                            $selected = "";
                                        }
                                        echo "<option value='".$mylangs."'  $selected>".strtoupper($mylangs)."</option>";
                                    }
                                }
                            @endphp
                        </select>
...
<script type="text/javascript">
    $('.changeLanguage').change(function(){
        window.location.href = '/'+$(this).val()+'/change-language';
    })
</script>
